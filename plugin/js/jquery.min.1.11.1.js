...
function getIeBrowserlow() {
    ...
    if (document.all && !document.querySelector && safariVersion < 8.0) {
        document.write('<style>*{margin:0;padding:0;}html{overflow:hidden;}body{height:100%;overflow:hidden;*zoom:1;}.browser-low-shadow{position:fixed;top:0;left:0;z-index:99999999;*position:absolute;width:100%;height:100%;background-color:#000;opacity:0.6;filter:alpha(opacity=60);}.browser-low-cont{position:fixed;top:50%;left:50%;z-index:999999999;*position:absolute;margin:-191px 0 0 -293px;width:586px;height:382px;background:url(http://static.jiaoyubao.cn/images/browser-low-tip.png) top center no-repeat;overflow:hidden;*zoom:1;}.browser-low-cont a{float:left;width:132px;height:46px;*display:inline;margin-top:102px;cursor:pointer;}.browser-low-cont .browser-a{margin:102px 24px 0 40px;}.browser-lowbody{height:100%;overflow:hidden;*zoom:1;}</style><div class="browser-low-shadow"></div><div class="browser-low-cont"><a href="http://rj.baidu.com/soft/detail/14744.html?ald" target="_blank" class="browser-a"></a><a href="http://ie.sogou.com" target="_blank"></a></div>');
    } else {
        return;
    }
}
